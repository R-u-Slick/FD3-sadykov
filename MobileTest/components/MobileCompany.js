    ...
    return (
      <div className='MobileCompany'>
        ...
        <div className='MobileCompanyFilter'>
          <input className='show-all' type="button" value="Все" onClick={this.showAll} />
          <input className='show-active' type="button" value="Активные" onClick={this.showActive} />
          <input className='show-blocked'type="button" value="Заблокированные" onClick={this.showBlocked} />
        </div>
      ...
      <div className='mobileCompanyAddClient'>
        {
          ...
          <input className='addClient' type="button" value="Добавить клиента" onClick={this.addClient} />
        }
      </div>
        {
